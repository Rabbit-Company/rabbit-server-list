export default class Validate{
	...
	static minecraftServerCategoryList = ['Anarchy', 'Bedwars', 'Creative', 'Cross-Play', 'Earth', 'Economy', 'Factions', 'FTB', 'Hardcore', 'KitPvP', 'LifeSeal', 'MCMMO', 'Mini Games', 'OneBlock', 'Parkour', 'Pixelmon', 'Prison', 'PvE', 'PvP', 'Raiding', 'Roleplay', 'Skyblock', 'Skywars', 'Survival', 'Survival Games', 'Tekkit', 'Towny', 'Vanilla', 'Whitelist'];
